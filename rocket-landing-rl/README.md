...
![Caca aos alvos: 10 voos ate alvos aereos em posicoes distintas](assets/target_montage.gif)

> **Task de alvo aereo**: um bullseye nasce em posicao aleatoria no ceu e o agente voa ate ENCOSTAR nele (acerto por contato, raio de 8 m — nao proximidade). Treinado por transfer do modelo generalista: **85% de acerto** em alvos aleatorios held-out, zero crashes. No jogo, a tecla B do modo Solo ativa o treino de alvo com som de conquista.
...
| **Alvo aereo** (bullseye aleatorio no ceu, acerto por contato) | **85%** em alvos held-out — zero crashes |
...
- **445 testes** automatizados (fisica, env, reward, GA, modos de jogo em SDL headless)
